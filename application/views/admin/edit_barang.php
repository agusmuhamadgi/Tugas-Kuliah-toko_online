                ...
                <?php foreach ($barang as $brg) : ?>
                    ...
                    <form method="post" action="<?= base_url('admin/update'); ?>">
                        ...
                        <div class="for-group">
                            ...
                            <input type="text" name="keterangan" id="keterangan" class="form-control " placeholder="Keterangan" value="<?= $brg->keterangan ?>">
                        </div>
                        <div class="for-group">
                            <label>Kategori</label>
                            <input type="text" name="kategori" id="kategori" class="form-control " placeholder="Kategori" value="<?= $brg->kategori ?>">
                        </div>
                        <div class="for-group">
                            <label>Harga</label>
