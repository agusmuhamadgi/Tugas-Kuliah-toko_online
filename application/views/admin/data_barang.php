                ...
                <tbody>
                    ...
                    foreach ($barang as $brg) : ?>
                        <tr>
                            ...
                            <td><?= $brg->harga ?></td>
                            <td><?= $brg->stok ?></td>
                            <td><?= anchor('admin/edit/' . $brg->id_barang, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'); ?></td>
                            <td><?= anchor('admin/hapus/' . $brg->id_barang, '<div class="btn btn-danger btn-sm "><i class="fas fa-trash "></i></div>'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
